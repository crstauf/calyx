...
<p style="text-align: center;"><img class="size-full aligncenter" title="Image Alignment 580x300" src="//placehold.it/580x300" alt="Image Alignment 580x300" width="580" height="300"></p>

<p>The image above happens to be&nbsp;<em><strong>centered</strong></em>.</p>

<p><strong><img class="size-full alignleft" title="Image Alignment 150x150" src="//placehold.it/150x150" alt="Image Alignment 150x150" width="150" height="150"></strong>The rest of this paragraph is filler&nbsp;for the sake of seeing the text wrap around the 150×150 image, which is <em><strong>left aligned</strong></em>.</p>
...
<p><img class="alignnone" title="Image Alignment 1200x400" src="//placehold.it/1200x400" alt="Image Alignment 1200x400" width="1200" height="400"></p>

<p>The image above, though 1200px wide, should not overflow the content area. It should remain contained with no visible disruption to the flow of content.</p>

<p><img class="size-full alignright" title="Image Alignment 300x200" src="//placehold.it/300x200" alt="Image Alignment 300x200" width="300" height="200"></p>
...
<div style="width: 590px" class="wp-caption aligncenter"><img class="size-full" title="Image Alignment 580x300" src="//placehold.it/580x300" alt="Image Alignment 580x300" width="580" height="300"><p class="wp-caption-text">Look at 580×300 getting some <a title="Image Settings" href="http://en.support.wordpress.com/images/image-settings/">caption</a> love.</p></div>
...
<div style="width: 160px" class="wp-caption alignleft"><img class="size-full" title="Image Alignment 150x150" src="//placehold.it/150x150" alt="Image Alignment 150x150" width="150" height="150"><p class="wp-caption-text">Itty-bitty caption.</p></div>
...
<div style="width: 100%; max-width: 1200px" class="wp-caption alignnone"><img title="Image Alignment 1200x400" src="//placehold.it/1200x400" alt="Image Alignment 1200x400" width="1200" height="400"><p class="wp-caption-text">Massive image comment for your eyeballs.</p></div>

<p>The image above, though 1200px wide, should not overflow the content area. It should remain contained with no visible disruption to the flow of content.</p>

<div style="width: 310px" class="wp-caption alignright"><img class="size-full" title="Image Alignment 300x200" src="//placehold.it/300x200" alt="Image Alignment 300x200" width="300" height="200"><p class="wp-caption-text">Feels good to be right all the time.</p></div>
